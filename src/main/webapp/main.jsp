...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){
		if($("#tabs").tabs("exists",text)){
			...
			var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='./page/"+url+"'></iframe>";
			$("#tabs").tabs("add",{
				title:text,
				iconCls:iconCls,
				closable:true,
...
<div region="center" >
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="red" size="10">欢迎${currentMemberShip.group.name}使用</font></div>
		</div>
	</div>
</div>
<div region="west" style="width: 200px;" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		...
		<c:if test="${currentMemberShip.group.name=='员工' || currentMemberShip.group.name=='管理员' }">
